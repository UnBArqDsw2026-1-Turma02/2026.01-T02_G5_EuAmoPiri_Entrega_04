# 4.6. Comentários e Reações em Relatos (RF12 / RF13) — Visão Arquitetural
...
- [4.4. Autenticação (Visão Arquitetural)](/docs/requisitos/RF01-backend/4.4.Autenticacao.md) — JWT e `requireTurista`
